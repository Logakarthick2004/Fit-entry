...
import { t as Route } from "./members._id-DW9X0_be.js";
import { n as useActiveTenant } from "./use-tenant-L5ZosG5R.js";
import { n as PageBody, r as PageHeader } from "./page-header-9A-c6Jmg.js";
import { i as formatDateTime, n as formatCurrency, r as formatDate } from "./utils-DMmnJHxL.js";
...
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-C8RpZWXk.js";
...
//#region src/routes/_authenticated/members.$id.tsx?tsr-split=component
function MemberDetail() {
	...
	const [startDate, setStartDate] = useState((/* @__PURE__ */ new Date()).toISOString().slice(0, 10));
	...
	if (!member) return /* @__PURE__ */ jsx(PageBody, { children: "Loading…" });
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(PageHeader, {
		...
		actions: /* @__PURE__ */ jsx(Link, {
			...
			children: /* @__PURE__ */ jsxs(Button, {
				variant: "outline",
				children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "mr-2 h-4 w-4" }), " Back"]
			})
		})
	}), /* @__PURE__ */ jsxs(PageBody, { children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("h3", {
						...
						children: [/* @__PURE__ */ jsx(DialogTrigger, {
							...
							children: /* @__PURE__ */ jsxs(Button, {
								size: "sm",
								children: [/* @__PURE__ */ jsx(Plus, { className: "mr-1 h-4 w-4" }), " Assign plan"]
							})
						}), /* @__PURE__ */ jsxs(DialogContent, { children: [
							/* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Assign membership" }) }),
							/* @__PURE__ */ jsxs("div", {
								className: "space-y-3",
								children: [
									/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Plan" }), /* @__PURE__ */ jsxs(Select, {
										value: planId,
										onValueChange: setPlanId,
										children: [/* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Choose plan" }) }), /* @__PURE__ */ jsx(SelectContent, { children: (plans ?? []).map((p) => /* @__PURE__ */ jsxs(SelectItem, {
											value: p.id,
											children: [
												p.name,
												" — ",
									...
									/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, { children: "Start date" }), /* @__PURE__ */ jsx(Input, {
										type: "date",
										value: startDate,
					...
					children: memberships && memberships.length > 0 ? memberships.map((m) => /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(Button, {
						...
						children: [/* @__PURE__ */ jsx(QrCode, { className: "mr-2 h-4 w-4" }), " Download"]
					})
				]
			})
		]
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("h3", {
				...
				children: [/* @__PURE__ */ jsx("thead", {
				...
				}), /* @__PURE__ */ jsxs("tbody", { children: [(payments ?? []).map((p) => /* @__PURE__ */ jsxs("tr", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("td", { children: formatCurrency(Number(p.amount), currency) }),
						/* @__PURE__ */ jsx("td", {
							className: "capitalize",
							children: p.method.replace("_", " ")
						}),
						/* @__PURE__ */ jsx("td", { children: p.status })
					]
				}, p.id)), (!payments || payments.length === 0) && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 4,
			...
			children: [/* @__PURE__ */ jsx("h3", {
				...
				children: [/* @__PURE__ */ jsx("thead", {
					...
					children: /* @__PURE__ */ jsxs("tr", { children: [
						...
						/* @__PURE__ */ jsx("th", { children: "Out" }),
						/* @__PURE__ */ jsx("th", { children: "Method" })
					] })
				}), /* @__PURE__ */ jsxs("tbody", { children: [(attendance ?? []).map((a) => /* @__PURE__ */ jsxs("tr", {
					className: "border-t border-border",
					children: [
						/* @__PURE__ */ jsx("td", {
							className: "py-2",
						...
						/* @__PURE__ */ jsx("td", { children: a.check_out ? formatDateTime(a.check_out) : "—" }),
						/* @__PURE__ */ jsx("td", {
							className: "uppercase text-xs",
							children: a.method
						})
					]
				}, a.id)), (!attendance || attendance.length === 0) && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
					colSpan: 3,
					className: "py-4 text-center text-muted-foreground",
